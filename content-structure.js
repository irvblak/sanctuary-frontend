(function(global){
  ...
  const SECTIONS = [
    ...
    {key:"residents-association-news-information",title:"Residents Association News & Information (RAN&I)",hat:"Residents Association Panel Member",icon:"👥",libraryDescription:"Panel news, notices and Residents Association information.",subcategories:[["news","News"],["info","Info"]],subcategoryLinks:{"info":[["Sanctuary Website Custody and Operating Guide","swcg-draft.html"],["The Sanctuary Website Audit Trail","audit-trail-notice.html"]]},schoolLinks:[["Residents Association Guide","role-guide.html?role=residents-association-panel"]]},
